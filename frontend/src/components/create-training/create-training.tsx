                    ...
                    <div className="custom-input create-training__input">
                      <label>
                        <span className="custom-input__wrapper">
                          <input type="text" name="training-name"></input>
                        </span>
                      </label>
                    </div>
                  </div>
                      ...
                      <div className="custom-input custom-input--with-text-right">
                        <label><span className="custom-input__label">Сколько калорий потратим</span>
                          <span className="custom-input__wrapper">
                            ...
                            <span className="custom-input__text">ккал
                            </span>
                          </span>
                        </label>
                      </div>
                        ...
                        <div className="custom-toggle-radio create-training__radio">
                          ...
                          <div className="custom-toggle-radio__block">
                            <label>
                              ...
                              <span className="custom-toggle-radio__icon"></span><span className="custom-toggle-radio__label">Женщинам</span>
                            </label>
                          </div>
                          <div className="custom-toggle-radio__block">
                            <label>
