function TrainerFriendsList():JSX.Element{
  return(
            ...
            <div className="thumbnail-friend__info thumbnail-friend__info--theme-light">
              <div className="thumbnail-friend__image-status">
                <div className="thumbnail-friend__image">
                  <picture>
                    <source type="image/webp" srcSet="img/content/thumbnails/friend-14.webp, img/content/thumbnails/friend-14@2x.webp 2x"></source>
                    <img src="img/content/thumbnails/friend-14.jpg" srcSet="img/content/thumbnails/friend-14@2x.jpg 2x" width="78" height="78" alt=""></img>
                  </picture>
          ...
          <div className="thumbnail-friend">
            <div className="thumbnail-friend__info thumbnail-friend__info--theme-light">
              <div className="thumbnail-friend__image-status">
                <div className="thumbnail-friend__image">
                  <picture>
                    <source type="image/webp" srcSet="img/content/thumbnails/friend-15.webp, img/content/thumbnails/friend-15@2x.webp 2x"></source>
                    <img src="img/content/thumbnails/friend-15.jpg" srcSet="img/content/thumbnails/friend-15@2x.jpg 2x" width="78" height="78" alt=""></img>
                  </picture>
                  {/* <!--<div className="thumbnail-friend__online-status thumbnail-friend__online-status--is-online"></div>--> */}
                </div>
              </div>
          ...
          <div className="thumbnail-friend">
            <div className="thumbnail-friend__info thumbnail-friend__info--theme-light">
              <div className="thumbnail-friend__image-status">
                <div className="thumbnail-friend__image">
                  <picture>
                    <source type="image/webp" srcSet="img/content/thumbnails/friend-16.webp, img/content/thumbnails/friend-16@2x.webp 2x"></source>
                    <img src="img/content/thumbnails/friend-16.jpg" srcSet="img/content/thumbnails/friend-16@2x.jpg 2x" width="78" height="78" alt=""></img>
                  </picture>
                  {/* <!--<div className="thumbnail-friend__online-status thumbnail-friend__online-status--is-online"></div>--> */}
                </div>
              </div>
          ...
          <div className="thumbnail-friend">
            <div className="thumbnail-friend__info thumbnail-friend__info--theme-light">
              <div className="thumbnail-friend__image-status">
                <div className="thumbnail-friend__image">
                  <picture>
                    <source type="image/webp" srcSet="img/content/thumbnails/friend-17.webp, img/content/thumbnails/friend-17@2x.webp 2x"></source>
                    <img src="img/content/thumbnails/friend-17.jpg" srcSet="img/content/thumbnails/friend-17@2x.jpg 2x" width="78" height="78" alt=""></img>
                  </picture>
                  {/* <!--<div className="thumbnail-friend__online-status thumbnail-friend__online-status--is-online"></div>--> */}
                </div>
              </div>
          ...
          <div className="thumbnail-friend">
            <div className="thumbnail-friend__info thumbnail-friend__info--theme-light">
              <div className="thumbnail-friend__image-status">
                <div className="thumbnail-friend__image">
                  <picture>
                    <source type="image/webp" srcSet="img/content/thumbnails/friend-18.webp, img/content/thumbnails/friend-18@2x.webp 2x"></source>
                    <img src="img/content/thumbnails/friend-18.jpg" srcSet="img/content/thumbnails/friend-18@2x.jpg 2x" width="78" height="78" alt=""></img>
                  </picture>
                  {/* <!--<div className="thumbnail-friend__online-status thumbnail-friend__online-status--is-online"></div>--> */}
                </div>
              </div>
          ...
          <div className="thumbnail-friend">
            <div className="thumbnail-friend__info thumbnail-friend__info--theme-light">
              <div className="thumbnail-friend__image-status">
                <div className="thumbnail-friend__image">
                  <picture>
                    <source type="image/webp" srcSet="img/content/thumbnails/friend-19.webp, img/content/thumbnails/friend-19@2x.webp 2x"></source>
                    <img src="img/content/thumbnails/friend-19.jpg" srcSet="img/content/thumbnails/friend-19@2x.jpg 2x" width="78" height="78" alt=""></img>
                  </picture>
          ...
          <div className="thumbnail-friend">
            <div className="thumbnail-friend__info thumbnail-friend__info--theme-light">
              <div className="thumbnail-friend__image-status">
                <div className="thumbnail-friend__image">
                  <picture>
                    <source type="image/webp" srcSet="img/content/thumbnails/friend-20.webp, img/content/thumbnails/friend-20@2x.webp 2x"></source>
                    <img src="img/content/thumbnails/friend-20.jpg" srcSet="img/content/thumbnails/friend-20@2x.jpg 2x" width="78" height="78" alt=""></img>
                  </picture>
                  {/* <!--<div className="thumbnail-friend__online-status thumbnail-friend__online-status--is-offline"></div>--> */}
                </div>
              </div>
          ...
          <div className="thumbnail-friend">
            <div className="thumbnail-friend__info thumbnail-friend__info--theme-light">
              <div className="thumbnail-friend__image-status">
                <div className="thumbnail-friend__image">
                  <picture>
                    <source type="image/webp" srcSet="img/content/thumbnails/friend-21.webp, img/content/thumbnails/friend-21@2x.webp 2x"></source>
                    <img src="img/content/thumbnails/friend-21.jpg" srcSet="img/content/thumbnails/friend-21@2x.jpg 2x" width="78" height="78" alt=""></img>
                  </picture>
                  {/* <!--<div className="thumbnail-friend__online-status thumbnail-friend__online-status--is-online"></div>--> */}
                </div>
              </div>
          ...
          <div className="thumbnail-friend">
            <div className="thumbnail-friend__info thumbnail-friend__info--theme-light">
              <div className="thumbnail-friend__image-status">
                <div className="thumbnail-friend__image">
                  <picture>
                    <source type="image/webp" srcSet="img/content/thumbnails/friend-09.webp, img/content/thumbnails/friend-09@2x.webp 2x"></source>
                    <img src="img/content/thumbnails/friend-09.jpg" srcSet="img/content/thumbnails/friend-09@2x.jpg 2x" width="78" height="78" alt=""></img>
                  </picture>
                  {/* <!--<div className="thumbnail-friend__online-status thumbnail-friend__online-status--is-online"></div>--> */}
                </div>
              </div>
